...
foreach(_cmake_expected_target IN ITEMS slang::fmt slang::boost_unordered slang::mimalloc-static slang::slang)
...
# Create imported target slang::fmt
add_library(slang::fmt STATIC IMPORTED)
...
# Create imported target slang::mimalloc-static
add_library(slang::mimalloc-static STATIC IMPORTED)

set_target_properties(slang::mimalloc-static PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/mimalloc-2.2;${_IMPORT_PREFIX}/include/mimalloc-2.2"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:pthread>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "include/mimalloc-2.2"
)
...
set_target_properties(slang::slang PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "slang::fmt;slang::boost_unordered;slang::mimalloc-static"
)
