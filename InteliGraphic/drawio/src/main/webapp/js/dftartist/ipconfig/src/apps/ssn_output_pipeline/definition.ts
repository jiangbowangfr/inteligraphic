...
export const def: DftsTypeDef = {
  ...
  nodes: {
    'OutputPipeline': {
      ...
      description: 'SSN/Datapath/OutputPipeline(id)',
      fields: [
        { attr: 'op_id', label: 'id', defaultValue: '1' },
      ...
      buildCode: ({ get }) => {
        ...
        return wrapSSNDatapath(`OutputPipeline(${id})`, inner);
      },
    },
    ...
    'OutputPipeline/Interface/IjtagScanInterface': {
