...
export const ssnDefinition: DftsTypeDef = {
  type: 'ssn_busfrequencydivider',
  title: 'DFT · SSN · BusFrequencyDivider',
  defaultNode: 'BusFrequencyDivider',
  nodes: {
    'BusFrequencyDivider': {
      title: 'BusFrequencyDivider',
      description: 'SSN/Datapath/BusFrequencyDivider(id) 顶层属性',
      fields: [
        { attr: 'bfd_id', label: 'id', defaultValue: '1' },
        ...
        { attr: 'parent_instance', label: 'parent_instance', placeholder: 'instance_name', defaultValue: '' },
        { attr: 'leaf_instance_name', label: 'leaf_instance_name', placeholder: 'leaf_instance_name', defaultValue: '' },
      ],
      buildCode: ({ get }) => {
        const id = get('bfd_id', '1');
        const inner = [
          ...
          block('Interface', [
            ...
            kv('bus_clock_out_local', get('if_bus_clock_out_local', 'bus_clock_out_local')),
        ...
        return wrapSSNDatapath(`BusFrequencyDivider(${id})`, inner);
      },
    },

    'BusFrequencyDivider/Interface': {
      title: 'Interface',
      description: 'Interface 端口命名（port_name 层）',
      fields: [
        ...
        { attr: 'if_bus_clock_out_local', label: 'bus_clock_out_local', defaultValue: 'bus_clock_out_local' },
    ...
    'BusFrequencyDivider/Interface/IjtagScanInterface': {
      title: 'IjtagScanInterface',
      description: 'IjtagScanInterface 端口命名（port_name 层）',
      fields: [
    ...
    'BusFrequencyDivider/Connections': {
      title: 'Connections',
      description: 'Connections（port_pin_name 层）',
      fields: [{ attr: 'c_bus_clock_in', label: 'bus_clock_in', defaultValue: 'ssn_bus_clock' }],
    },
  },
};

export default ssnDefinition;
