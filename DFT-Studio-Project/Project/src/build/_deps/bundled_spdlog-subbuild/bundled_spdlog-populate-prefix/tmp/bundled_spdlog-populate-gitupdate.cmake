...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.14.1"
  WORKING_DIRECTORY "/home/mingzhejiang/Projects/github/OpenROAD/DFT-Studio-Project/Project/src/build/_deps/bundled_spdlog-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/mingzhejiang/Projects/github/OpenROAD/DFT-Studio-Project/Project/src/build/_deps/bundled_spdlog-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mingzhejiang/Projects/github/OpenROAD/DFT-Studio-Project/Project/src/build/_deps/bundled_spdlog-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
